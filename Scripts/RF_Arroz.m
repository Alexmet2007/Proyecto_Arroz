...
T = repmat([1 2 3 4 5],25,1); %Se crea una matriz con las etiquetas posibles para las muestras (5 filas, 7 columnas)
...
save RF_model97 myRF % guardar modelo clasificador